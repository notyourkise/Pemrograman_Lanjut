...
<div class="breadcrumb"><a href="/MATERI-ASDOS/Week6/public/">Beranda</a><span class="sep">/</span><a href="?c=appointments&a=index">Janji Temu</a></div>
<div class="card">
...
<script>
  function confirmDelete(id){const f=document.getElementById('deleteForm');f.action=`?c=appointments&a=delete&id=${id}`;document.getElementById('deleteModal').style.display='block';}
