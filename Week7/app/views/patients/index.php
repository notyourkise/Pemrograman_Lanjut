<?php $title = 'Pasien - Week7'; require __DIR__ . '/../layout/header.php'; ?>
<div class="stack">
  <div class="card">
  <div class="breadcrumb"><a href="/MATERI-ASDOS/Week7/public/">Beranda</a><span class="sep">/</span><a href="?c=patients&a=index">Pasien</a></div>
    <div style="display:flex; justify-content: space-between; align-items:center; gap:12px;">
      ...
      <div style="display:flex; gap:8px;">
        <a class="btn btn-outline" href="?c=patients&a=recycle">🗑️ Recycle Bin</a>
...
<div id="modal-backdrop" class="modal-backdrop"><div class="modal"><div class="modal-header">Konfirmasi Hapus</div><div class="modal-body"><p>Anda yakin ingin menghapus pasien <strong id="modal-name"></strong>?</p><p class="muted" style="font-size: 0.9rem;">Data akan dipindahkan ke Recycle Bin.</p></div><div class="modal-actions"><form id="modal-form" method="post" action=""><?= Csrf::field() ?><button type="submit" class="btn btn-danger">Ya, Hapus</button></form><button type="button" class="btn btn-outline" id="modal-cancel">Batal</button></div></div></div>
