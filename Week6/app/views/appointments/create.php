...
<div class="breadcrumb"><a href="/MATERI-ASDOS/Week6/public/">Beranda</a><span class="sep">/</span><a href="?c=appointments&a=index">Janji Temu</a><span class="sep">/</span><span>Tambah</span></div>
<div class="card">
  <form method="post">
    ...
    <div class="form-group">
      ...
      <select name="doctor_id" class="input">
        ...
        <?php foreach (($doctors ?? []) as $d): ?>
          <option value="<?= (int)$d['id'] ?>" <?= ((int)$old['doctor_id'] === (int)$d['id']) ? 'selected' : '' ?>><?= htmlspecialchars($d['name']) ?></option>
        <?php endforeach; ?>
      </select>
      <?php if (!empty($errors['doctor_id'])): ?><div class="error"><?= htmlspecialchars($errors['doctor_id']) ?></div><?php endif; ?>
    </div>
    <div class="form-group">
      <label>Jadwal</label>
